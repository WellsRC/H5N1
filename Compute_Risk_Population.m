...
for mm=1:size(bin_suc,1)
    ...
    for ss=1:length(State_Name)
        ...
        c_r=c_r(t_inc);
        susceptible_risk_population_State_COVID(ss,mm)=1-prod((1-c_r));
    end
end
...
for mm=1:size(bin_suc,1)
    ...
    for ss=1:length(State_Name)
        ...
        t_inc=w_c>0 & ~isnan(c_r);
        c_r=c_r(t_inc);
        susceptible_risk_population_State_H1N1(ss,mm)=1-prod((1-c_r));
    end
end
...
%% Combined: H1N1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Population_Models_Fit_Combined.mat',"par_est_H1N1","w_AIC_Combined");
...
susceptible_risk_population_County_Combined_H1N1=zeros(height(US_County),length(par_est_H1N1));
susceptible_risk_population_State_Combined_H1N1=zeros(length(State_Name),length(par_est_H1N1));
...
for mm=1:size(bin_suc,1)
    ...
    sigma_ln=10.^x(end);
    susceptible_risk_population_County_Combined_H1N1(:,mm) = Risk_Assesment_Farms(beta_x,X_County_H5N1);                

    for ss=1:length(State_Name)
        t_state=strcmp(State_Name{ss},US_County.STATE_NAME);

        c_r=susceptible_risk_population_County_Combined_H1N1(t_state,mm);
        w_c=US_County.POPULATION_SIZE_2022(t_state);
        t_inc=w_c>0 & ~isnan(c_r);
        c_r=c_r(t_inc);
        susceptible_risk_population_State_Combined_H1N1(ss,mm)=1-prod((1-c_r));
    end
end

avg_susceptible_risk_population_County_Combined_H1N1=susceptible_risk_population_County_Combined_H1N1*w_AIC_Combined;
avg_susceptible_risk_population_State_Combined_H1N1=susceptible_risk_population_State_Combined_H1N1*w_AIC_Combined;

save('Average_Risk_Population_Combined_H1N1.mat','avg_susceptible_risk_population_County_Combined_H1N1','susceptible_risk_population_County_Combined_H1N1','w_AIC_Combined','avg_susceptible_risk_population_State_Combined_H1N1','susceptible_risk_population_State_Combined_H1N1','State_Name');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Combined: COVID
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Population_Models_Fit_Combined.mat',"par_est_COVID","w_AIC_Combined");
...
susceptible_risk_population_County_Combined_COVID=zeros(height(US_County),length(par_est_COVID));
susceptible_risk_population_State_Combined_COVID=zeros(length(State_Name),length(par_est_COVID));
...
for mm=1:size(bin_suc,1)
    ...
    sigma_ln=10.^x(end);
    susceptible_risk_population_County_Combined_COVID(:,mm) = Risk_Assesment_Farms(beta_x,X_County_H5N1);                

    for ss=1:length(State_Name)
        t_state=strcmp(State_Name{ss},US_County.STATE_NAME);

        c_r=susceptible_risk_population_County_Combined_COVID(t_state,mm);
        w_c=US_County.POPULATION_SIZE_2022(t_state);
        t_inc=w_c>0 & ~isnan(c_r);
        c_r=c_r(t_inc);
        susceptible_risk_population_State_Combined_COVID(ss,mm)=1-prod((1-c_r));
    end
end

avg_susceptible_risk_population_County_Combined_COVID=susceptible_risk_population_County_Combined_COVID*w_AIC_Combined;
avg_susceptible_risk_population_State_Combined_COVID=susceptible_risk_population_State_Combined_COVID*w_AIC_Combined;

save('Average_Risk_Population_Combined_COVID.mat','avg_susceptible_risk_population_County_Combined_COVID','susceptible_risk_population_County_Combined_COVID','w_AIC_Combined','avg_susceptible_risk_population_State_Combined_COVID','susceptible_risk_population_State_Combined_COVID','State_Name');
