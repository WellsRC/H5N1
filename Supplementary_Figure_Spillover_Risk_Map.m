...
avg_spillover_risk_farm_State=NaN.*zeros(size(State_Name));

load([pwd '/Data/Data_US_County.mat'],'US_County');

if(strcmp(Var_Plot,'Poultry'))
    load('Average_Risk_Poultry.mat','avg_spillover_risk_poultry_farm_County','avg_spillover_risk_poultry_farm_State');
...
% State-level
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
avg_spillover_risk_farm_State=log(avg_spillover_risk_farm_State);
risk_measure=(avg_spillover_risk_farm_State-min(avg_spillover_risk_farm_State))./(max(avg_spillover_risk_farm_State)-min(avg_spillover_risk_farm_State));
