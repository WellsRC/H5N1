...
Farm_Variables_v={'Turkey_Operations','Broiler_Operations','Layer_Operations','Pullet_Operations','Temperature'};
...
for ss=10:-1:2
    ...
    parfor mm=m_start:m_end
        ...
        if(sum(bin_farm(mm,6:10))>0)
            Farm_Variables=Farm_Variables_v(bin_farm(mm,6:10));
        else
            Farm_Variables={};
        end
