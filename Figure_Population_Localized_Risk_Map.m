function  Figure_Population_Localized_Risk_Map()
% Plot_Variable
close all;
...
load('Total_Spillover_Risk_County.mat','avg_spillover_risk_total_County');
...
avg_susceptible_risk_population_County_COVID=avg_susceptible_risk_population_County_COVID.*avg_spillover_risk_total_County(t_f);
avg_susceptible_risk_population_County_H1N1=avg_susceptible_risk_population_County_H1N1.*avg_spillover_risk_total_County(t_f);
avg_susceptible_risk_population_County=avg_susceptible_risk_population_County.*avg_spillover_risk_total_County(t_f);
...
for vv=1:4
    ...
    switch vv
        ...
        case 4
            ...
            ylabel({'State overall','susceptible spillover risk'},'FontSize',18);
...
print(gcf,['Preliminary_Population_Localized_Risk_Plot.png'],'-dpng','-r300');
end
