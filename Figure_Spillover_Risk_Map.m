function  Figure_Spillover_Risk_Map()
% Plot_Variable
close all;
...
load('Average_Risk_Poultry.mat','avg_spillover_risk_poultry_farm_County');
load('Average_Risk_Dairy.mat','avg_spillover_risk_dairy_farm_County');
...
for ss=1:length(State_Name)
    ...
    c_r=avg_spillover_risk_total_County(t_state);
...
for vv=1:4
    ...
    switch vv
        case 1
            ...
            Title_Name={'Risk of spillover','from poultry farms'};
            
            risk_measure=avg_spillover_risk_poultry_farm_County;
        case 2
            subplot('Position',[0.885,0.525,0.01,0.45]);
            Title_Name={'Risk of spillover','from dairy farms'};
           

            risk_measure=avg_spillover_risk_dairy_farm_County;
        case 3
            subplot('Position',[0.41,0.025,0.01,0.45]);    
            Title_Name={'Risk of spillover','from poultry and dairy farms'};
    ...
    switch vv
        ...
        case 4
            ...
            ylabel({'State overall risk','of spillover'},'FontSize',18);
...
print(gcf,['Preliminary_Spillover_Risk_Plot.png'],'-dpng','-r300');
end
