...
X_temp(isnan(X_temp))=0; % Need to st to zero as not included in the model

Zero_Inflated=w_AIC'*X_temp(:,1:11);
Outbreak_Model=w_AIC'*X_temp(:,12:25);
Spillover_per_Outbreak=w_AIC'*X_temp(:,26);
