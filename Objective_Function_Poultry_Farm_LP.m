function F = Objective_Function_Poultry_Farm_LP(indx,x0,xv,F_County,X_County,P_County,County_Farms,Affected_County_Farms,state_weight_matrix,State_Spillover_Events,logic_temperature)

x=zeros(1,length(xv)+1);
x(indx)=x0;
x(~ismember([1:length(x)],indx))=xv;
