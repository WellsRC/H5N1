...
median_County_dairy_onward=median(County_dairy_onward(~(no_farms & no_diary_farms),:),1);
...
min_State_dairy_onward=min(State_dairy_onward,[],1);
max_State_dairy_onward=max(State_dairy_onward,[],1);
median_State_dairy_onward=median(State_dairy_onward,1);

min_State_dairy_onward_95=prctile(min_State_dairy_onward,[2.5 97.5]);
max_State_dairy_onward_95=prctile(max_State_dairy_onward,[2.5 97.5]);
median_State_dairy_onward_95=prctile(median_State_dairy_onward,[2.5 97.5]);

save('Onward_Transmission.mat','min_State_dairy_onward_95','median_State_dairy_onward_95','max_State_dairy_onward_95','mle_County_dairy_onward','County_dairy_onward_95','State_dairy_onward_95','mle_State_dairy_onward','min_County_dairy_onward_95','median_County_dairy_onward_95','max_County_dairy_onward_95','mle_County_onward','County_onward_95','State_onward_95','mle_State_onward','min_County_onward_95','median_County_onward_95','max_County_onward_95');