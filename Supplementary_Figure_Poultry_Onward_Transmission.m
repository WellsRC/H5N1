...
load('Poultry_Risk_AIC.mat','mle_onward_transmission_poultry_farm_County','no_farms');

avg_onward_transmission_County=mle_onward_transmission_poultry_farm_County;
