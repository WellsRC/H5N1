...
load('Average_Risk_Dairy_Reduction_Connectivity=100.mat','w_AIC','spillover_risk_dairy_farm_County','avg_overall_risk_dairy_farm_County','spillover_risk_dairy_farm_State');
d_AIC=w_AIC;
...
save('Total_Spillover_Risk_County_COVID_Dairy_Reduction_Connectivity=100.mat','avg_spillover_risk_total_County','avg_spillover_risk_total_State','State_Name','avg_localized_transmission_risk_total_State','avg_localized_transmission_risk_total_County');
...
avg_spillover_risk_total_County(isnan(avg_overall_risk_dairy_farm_County) & isnan(avg_overall_risk_poultry_farm_County)) = NaN; % i.e. model suggests that since no farms/data cannot infer
avg_localized_transmission_risk_total_County(isnan(avg_overall_risk_dairy_farm_County) & isnan(avg_overall_risk_poultry_farm_County)) = NaN;
save('Total_Spillover_Risk_County_H1N1_Dairy_Reduction_Connectivity=100.mat','avg_spillover_risk_total_County','avg_spillover_risk_total_State','State_Name','avg_localized_transmission_risk_total_State','avg_localized_transmission_risk_total_County');
