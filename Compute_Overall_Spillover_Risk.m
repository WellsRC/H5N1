clear;
clc;
load('Average_Risk_Dairy.mat','w_AIC','spillover_risk_dairy_farm_County','avg_overall_risk_dairy_farm_County');
d_AIC=w_AIC;
load('Average_Risk_Poultry.mat','w_AIC','spillover_risk_poultry_farm_County','avg_overall_risk_poultry_farm_County');
p_AIC=w_AIC;
...
save('Total_Spillover_Risk_County.mat','avg_spillover_risk_total_County');
